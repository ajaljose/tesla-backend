...
```mermaid
graph TD
    Client[Client Apps] --> Routes[Express Routes]
    Routes --> Middleware[Yup Validation / Auth]
    Middleware --> Controllers[Controllers]
    Controllers --> Services[Business Logic / Services]
    Services --> Transactions[Sequelize Transactions]
    Transactions --> Models[Sequelize Models]
